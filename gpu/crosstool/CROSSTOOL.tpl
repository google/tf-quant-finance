...
%{cxx_builtin_include_directory}
  ...
  # TODO: Review those flags below, they should be defined by cl.exe
  ...
  # TODO: Previously we were using a .bat file to start python to run
  ...
  # TODO: Remove legacy_compile_flags feature when legacy fields are
