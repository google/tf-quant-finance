...
class BarrierOptionTest(tf.test.TestCase):
    ...
    def test_integral1(self):
        """ Function tests integral1 used to approximate barrier option price """
        rate = 0.2
        asset_yield = .1
        asset_price = 150.0
        strike_price = 100.0
        ...
        rtn_vals = barrier_option._integral12(1.0, rate, asset_price, asset_yield, time_to_maturity, strike_price, params, "x")
        real_val = self._i12(1.0, rate, asset_price, asset_yield, time_to_maturity, strike_price, params, "x")
        # compare with 80.1052
        self.assertAllClose(rtn_vals, 80.1052)
    ...
    def test_integral2(self):
        ...
        rtn_vals = barrier_option._integral12(1.0, rate, asset_price, asset_yield, time_to_maturity, strike_price, params, "x1")
        real_val = self._i12(1.0, rate, asset_price, asset_yield, time_to_maturity, strike_price, params, "x1")
        # print(rtn_vals, real_val)
        # compare with 78.4949
        self.assertAllClose(rtn_vals, 78.4949)
    ...
    def test_integral3(self):
        ...
        rtn_vals = barrier_option._integral34(1.0, 1.0, rate, asset_price, asset_yield, time_to_maturity, strike_price, barrier_price, params, "y")
        real_val = self._i34(1.0, 1.0, rate, asset_price, asset_yield, time_to_maturity, strike_price, barrier_price, params, "y")
        # print(rtn_vals, real_val)
        # compare with 11.802524
        self.assertAllClose(rtn_vals, 11.802524)
    ...
    def test_integral4(self):
        ...
        rtn_vals = barrier_option._integral34(1.0, 1.0, rate, asset_price, asset_yield, time_to_maturity, strike_price, barrier_price, params, "y1")
        real_val = self._i34(1.0, 1.0, rate, asset_price, asset_yield, time_to_maturity, strike_price, barrier_price, params, "y1")
        # print(rtn_vals, real_val)
        # compare with 10.38408
        self.assertAllClose(rtn_vals, 10.38408)


    def test_integral5(self):
        """Function tests integral5 approximation"""
        rate = 0.2
        asset_yield = .1
        asset_price = 150.0
        strike_price = 100.0
        ...
        rtn_vals = barrier_option._integral5(1.0, 10, rate, asset_price, time_to_maturity, barrier_price, params)
        real_val = self._i5(1.0, pay_off, rate, asset_price, time_to_maturity, barrier_price, params)
        # 0.8429868
        # print(rtn_vals, real_val)
        self.assertAllClose(rtn_vals, 0.842986)

    def test_integral6(self):
        """Function tests integral5 approximation"""
        rate = 0.2
        asset_yield = .1
        asset_price = 150.0
        ...
        rtn_vals = barrier_option._integral6(1.0, 10, asset_price, barrier_price, params)
        real_val = self._i6(1.0, 10, asset_price, barrier_price, params)
        # print(rtn_vals, real_val)
        # 4.929462
        self.assertAllClose(rtn_vals, 4.929462)
    ...
    def down_and_in_call(self):
        ...
        val = barrier_option.down_and_in_call(1.0, rate, asset_yield, asset_price, strike_price, barrier_price, pay_off, time_to_maturity, params)
        print("price: ", val)
