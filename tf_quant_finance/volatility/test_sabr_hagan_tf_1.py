...
# limitations under the License.hor: Joerg Kienitz
...
for d in displacement_vec:
    print('displacement:', d)
    kmin = -d
    kmax = 10
    kval = np.arange(kmin, kmax, 0.01)
    yval = sabr.volsabr_h_n_tf(f, kval, T, d, alpha_org, beta_org, rho_org,nu_org)
    plt.plot(kval,yval,label=d)
