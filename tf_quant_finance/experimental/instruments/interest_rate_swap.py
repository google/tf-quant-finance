  ...
  def __init__(self,
    ...
    Args:
      ...
      maturity_date: A rank 1 `DateTensor` specifying the maturity dates for
        ...
        `start_date`.
      pay_leg: A list of either `FixedCouponSpecs` or `FloatCouponSpecs`
        ...
        being created.
      receive_leg: A list of either `FixedCouponSpecs` or `FloatCouponSpecs`
