...
import enum
from tf_quant_finance.experimental.pricing_platform.instrument_protos import day_count_conventions_pb2

DayCountConventions = enum.Enum(
    "DayCountConventions",
    zip(day_count_conventions_pb2.DayCountConvention.keys(),
        day_count_conventions_pb2.DayCountConvention.keys()))
...
def from_proto_value(value: int) -> DayCountConventionsProtoType:
  ...
  return DayCountConventions(
      day_count_conventions_pb2.DayCountConvention.Name(value))
