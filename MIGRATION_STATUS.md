...
**Branch:** `feat/jax-migration` | **JAX 0.9.2** | **Full suite: 1190 passed** (+434% from 222)  
**145+ commits** | **Shim-based incremental migration**
...
| math/pde | 76/88 | ✅ 86% (pad widths fixed) |
