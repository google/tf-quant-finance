...
Prices barrier options in a Black-Scholes Model. (deprecated arguments)
...
tf_quant_finance.black_scholes.barrier_price(
    ...
    cost_of_carries=None, is_barrier_down=None, is_knock_out=None,
    is_call_options=None, dtype=None, name=None
)
```
...
Warning: SOME ARGUMENTS ARE DEPRECATED: `(continuous_dividends)`. They will be removed after 2021-07-01.
