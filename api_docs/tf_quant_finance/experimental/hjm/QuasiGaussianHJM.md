...
<meta itemprop="name" content="tf_quant_finance.experimental.hjm.QuasiGaussianHJM" />
...
# tf_quant_finance.experimental.hjm.QuasiGaussianHJM
...
<a target="_blank" href="https://github.com/google/tf-quant-finance/blob/master/tf_quant_finance/experimental/hjm/quasi_gaussian_hjm.py">View source</a>
...
* <b>`mean_reversion`</b>: A real positive `Tensor` of shape `[dim]`. Corresponds
...
sample_discount_curve_paths(
    times, curve_times, num_samples, time_step, random_type=None, seed=None, skip=0,
    name=None
)
```
...
```python
sample_paths(
    times, num_samples, time_step, random_type=None, seed=None, skip=0, name=None
)
```
