...
tf_quant_finance.models.sabr.approximations.calibration(
    *, prices, strikes, expiries, forwards, is_call_options, beta, nu, rho, volatili
    ...
    oximationType.HAGAN, alpha=None, alpha_lower_bound=None, alpha_upper_bound=None,
    calibrate_beta=False, beta_lower_bound=0.0, beta_upper_bound=1.0,
    nu_lower_bound=0.0, nu_upper_bound=1.0, rho_lower_bound=-1.0,
