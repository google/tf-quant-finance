...
tf_quant_finance.models.hjm.bond_option_price(
    *, strikes, expiries, maturities, discount_rate_fn, dim, mean_reversion,
    volatility, is_call_options=True, num_samples=1, random_type=None, seed=None,
    skip=0, time_step=None, dtype=None, name=None
)
```
...
* <b>`volatility`</b>: A real positive `Tensor` of the same `dtype` as `mean_reversion`
