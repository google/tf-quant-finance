...
class StatelessRandomOpsTest(tf.test.TestCase):
  ...
  def testOutputIsPermutation(self):
    ...
    for dtype in (tf.int32, tf.int64, tf.float32, tf.float64):
      ...
      random_shuffle_seed_1 = stateless_random_ops.stateless_random_shuffle(
          identity_permutation, seed=tf.constant((1, 42), tf.int64))
      random_shuffle_seed_2 = stateless_random_ops.stateless_random_shuffle(
  ...
  def testOutputIsStateless(self):
    ...
    for dtype in (tf.int32, tf.int64, tf.float32, tf.float64):
      random_permutation = stateless_random_ops.stateless_random_shuffle(
  ...
  def testOutputIsIndependentOfInputValues(self):
    ...
    for dtype in (tf.int32, tf.int64, tf.float32, tf.float64):
      ...
      random_shuffle_control = stateless_random_ops.stateless_random_shuffle(
  ...
  def testMultiDimensionalShape(self):
    ...
    for dtype in (tf.int32, tf.int64, tf.float32, tf.float64):
      input_permutation = tf.constant([[[1], [2], [3]], [[4], [5], [6]]],
                                      dtype=dtype)
      random_shuffle = stateless_random_ops.stateless_random_shuffle(
