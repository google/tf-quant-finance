...
RUN apt-get update && apt-get install -y curl wget build-essential rsync vim python-pip openjdk-11-jdk sudo python3 python3-pip git
...
RUN pip3 install --upgrade tensorflow tensorflow-probability numpy attrs scipy
